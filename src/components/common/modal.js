                ...
                <div className={ModalStyles.actions}>
                  <div className={ModalStyles.controls}>
                    <div className={ModalStyles.control}>
                      ...
                      >
                        J'ai lu et j'accepte les <a href="#" target="_blank">Conditions Générales d’Utilisation</a> qui autorisent cette plateforme à conserver mes données personnelles,
                        calculer mon niveau d'adéquation avec les offres et partager mon profil avec les recruteurs du réseau professionnel.
