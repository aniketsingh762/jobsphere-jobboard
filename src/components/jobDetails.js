import { faBriefcase, faCalendar, faFileAlt, faIndustry, faMapMarkerAlt } from '@fortawesome/free-solid-svg-icons';
                ...
                <div className="col-60 col-67">
                    {props.documentParsing.s && (
                        <div className="jobs details">
                            ...
                            <Share
                            socialConfig={{
                                twitterHandle: 'jobsphere',
                                config: {
                                    url: `https://jobsphere.com/?job_key=${jobData.key}&board_key=49348f504e997c501e45a3634dce5a865370ff90`,
                                    title: name,
                                    },
                                }}
                            />
